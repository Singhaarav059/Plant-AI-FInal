def get_translations(lang):
    ...
    english = {
        ...
        'analyzing_hint': 'This can take up to 30 seconds depending on your photo.',
        ...
        'reset_password_instruction': 'Enter your username and email, then choose a new password.',
        'new_password': 'New Password',
        'reset_password_button': 'Reset Password',
        'password_reset_success': 'Password reset successful! Please login with your new password.',
        'user_not_found': 'No account found with that username and email.',
    ...
    hindi = {
        ...
        'analyzing_hint': 'आपकी फोटो के आधार पर इसमें 30 सेकंड तक लग सकते हैं।',
        ...
        'reset_password_instruction': 'अपना उपयोगकर्ता नाम और ईमेल दर्ज करें, फिर एक नया पासवर्ड चुनें।',
        'new_password': 'नया पासवर्ड',
        'reset_password_button': 'पासवर्ड रीसेट करें',
        'password_reset_success': 'पासवर्ड रीसेट सफल! कृपया अपने नए पासवर्ड से लॉगिन करें।',
        'user_not_found': 'उस उपयोगकर्ता नाम और ईमेल के साथ कोई खाता नहीं मिला।',
    ...
    tamil = {
        ...
        'analyzing': 'உங்கள் புகைப்படம் பகுப்பாய்வு செய்யப்படுகிறது...',
        'analyzing_hint': 'உங்கள் புகைப்படத்தைப் பொறுத்து இதற்கு 30 வினாடிகள் வரை ஆகலாம்.',
        ...
        'reset_password_instruction': 'உங்கள் பயனர்பெயர் மற்றும் மின்னஞ்சலை உள்ளிடவும், பின்னர் புதிய கடவுச்சொல்லைத் தேர்ந்தெடுக்கவும்.',
        'new_password': 'புதிய கடவுச்சொல்',
        'reset_password_button': 'கடவுச்சொல்லை மீட்டமைக்கவும்',
        'password_reset_success': 'கடவுச்சொல் மீட்டமைப்பு வெற்றி! உங்கள் புதிய கடவுச்சொல்லுடன் உள்நுழையவும்.',
        'user_not_found': 'அந்த பயனர்பெயர் மற்றும் மின்னஞ்சலுடன் கணக்கு எதுவும் இல்லை.',
    ...
    telugu = {
        ...
        'analyzing': 'మీ ఫోటో విశ్లేషించబడుతోంది...',
        'analyzing_hint': 'మీ ఫోటోను బట్టి దీనికి 30 సెకన్ల వరకు పట్టవచ్చు.',
        ...
        'reset_password_instruction': 'మీ యూజర్‌నేమ్ మరియు ఇమెయిల్ నమోదు చేయండి, తర్వాత కొత్త పాస్‌వర్డ్ ఎంచుకోండి.',
        'new_password': 'కొత్త పాస్‌వర్డ్',
        'reset_password_button': 'పాస్‌వర్డ్ రీసెట్ చేయండి',
        'password_reset_success': 'పాస్‌వర్డ్ రీసెట్ విజయవంతమైంది! దయచేసి మీ కొత్త పాస్‌వర్డ్‌తో లాగిన్ చేయండి.',
        'user_not_found': 'ఆ యూజర్‌నేమ్ మరియు ఇమెయిల్‌తో ఖాతా కనుగొనబడలేదు.',
    ...
    bengali = {
        ...
        'analyzing_hint': 'আপনার ছবির উপর নির্ভর করে এতে ৩০ সেকেন্ড পর্যন্ত সময় লাগতে পারে।',
        ...
        'reset_password_instruction': 'আপনার ব্যবহারকারীর নাম এবং ইমেল লিখুন, তারপর একটি নতুন পাসওয়ার্ড বেছে নিন।',
        'new_password': 'নতুন পাসওয়ার্ড',
        'reset_password_button': 'পাসওয়ার্ড রিসেট করুন',
        'password_reset_success': 'পাসওয়ার্ড রিসেট সফল! অনুগ্রহ করে আপনার নতুন পাসওয়ার্ড দিয়ে লগইন করুন।',
        'user_not_found': 'সেই ব্যবহারকারীর নাম এবং ইমেল দিয়ে কোনো অ্যাকাউন্ট পাওয়া যায়নি।',
    ...
    gujarati = {
        ...
        'analyzing': 'તમારો ફોટો વિશ્લેષણ થઈ રહ્યો છે...',
        'analyzing_hint': 'તમારા ફોટો પર આધાર રાખીને આમાં 30 સેકન્ડ સુધીનો સમય લાગી શકે છે.',
        ...
        'reset_password_title': 'પાસવર્ડ રીસેટ કરો',
        'reset_password_instruction': 'તમારું વપરાશકર્તા નામ અને ઈમેલ દાખલ કરો, પછી નવો પાસવર્ડ પસંદ કરો.',
        'new_password': 'નવો પાસવર્ડ',
        'reset_password_button': 'પાસવર્ડ રીસેટ કરો',
        'password_reset_success': 'પાસવર્ડ રીસેટ સફળ! કૃપા કરીને તમારા નવા પાસવર્ડ સાથે લોગિન કરો.',
        'user_not_found': 'તે વપરાશકર્તા નામ અને ઈમેલ સાથે કોઈ ખાતું મળ્યું નથી.',
